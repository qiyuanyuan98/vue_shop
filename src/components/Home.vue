  ...
  <el-container class="home_container">
    ...
    <el-container>
      ...
      <el-aside :width="isCollaps ? '64px' : '200px'">
        ...
        <!-- 侧边菜单栏 -->
         <el-menu :default-active='activePath' :router='true' :unique-opened="true" :collapse="isCollaps" :collapse-transition='false' background-color="#333744" text-color="#fff" active-text-color="#409eff">
            <!-- 一级菜单 -->
